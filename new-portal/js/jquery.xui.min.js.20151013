...
(function($) {
    ...
    function validate(target, showTipMsg) {
        var state = $.data(target, 'validatebox');
        var opts = state.options;
        var tip = state.tip;
        var box = $(target);        
    ...
    function load(target, data) {
        ...
        function _load(data) {
            ...
            for (var name in data) {
                ...
                if ($.fn.combobox) {
                    $('input[name="' + name + '"]', form).closest('.combobox-f').combobox('setValue', val);
                }
            }
        }
    }
...
(function($) {
	...
	function initDom(target) {
		...
		dg.children('.datagrid-header').html(t.attr('title'));
		t.after(dg);
